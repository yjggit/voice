...
/**
 * @author jianhui.Yang
 * @version $Id ComApi.java, v 0.1 2018-11-09 9:28 jianhui.Yang Exp $$
 */
@Entity
@Table(name = "comp_api")
public class CompApi implements Serializable {
    ...
    @Column(name = "api_url",columnDefinition = "VARCHAR(500) NOT NULL COMMENT '远程地址' ")
    ...
    @Column(name = "cache_interface",columnDefinition = "VARCHAR(200) NOT NULL COMMENT '缓存服务' ")
